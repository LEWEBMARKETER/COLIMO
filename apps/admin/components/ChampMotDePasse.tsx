...
export default function ChampMotDePasse({ className = "", ...props }: ChampMotDePasseProps) {
  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className="absolute right-2 top-1/2 -translate-y-1/2 text-colimo-neutre-fonce/40 hover:text-colimo-neutre-fonce"
      >
        {visible ? (
