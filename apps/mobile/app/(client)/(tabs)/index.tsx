...
export default function ClientHome() {
  ...
  if (utilisateur?.typeClient === "commerce") {
    // L'en-tête (salutation, cloche, bandeau push) est géré par
    // CommerceDashboard lui-même, dans son propre FondEntete — évite de le
    // fragmenter entre ce fichier et le composant.
    return (
